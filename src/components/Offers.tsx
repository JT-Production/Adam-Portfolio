...
const Offers = () => {
  return (
    <div className="lg:px-35 pb-10   md:py-0 lg:py-0 lg:mt-0 md:mt-0 relative z-0 inset-0 px-1 " id="offer">
        <h1 className="font-bold text-3xl mb-5 px-3">Click for more information</h1>
...
<img src={success} alt=""  className="h-40 cssanimation hu__hu__  lg:mx-auto" style={{ WebkitFilter: 'drop-shadow(5px 5px 5px  #ff8c0062)', filter: 'drop-shadow(5px 5px 10px #ff8c0062)' }} />
                <h2 className="text-[22px] mb-3 heading ">Bitcoin Blueprint Premium PDF</h2>
                <p className="text-white/50">Unlock the advanced PDF guide with deeper insights and strategies for serious learners.</p>
