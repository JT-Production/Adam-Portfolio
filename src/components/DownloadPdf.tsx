...
//   };
  ...
  return (
    // <button onClick={handleDownload} className='relative inset-0'>{label}</button>
     <Button onClickk={handleDownload} link="" text="Free PDF Guide"  classNam="relative inset-0 flex items-center gap-2 bg-transparent border border-orange-400 hover:bg-zinc-900" icon={<MdOutlineFileDownload />} />
  )
};
